			...
			<div class="cart-inner">
				<div class="cart-thead clearfix">
					<div class="column t-checkbox form">
						<input type="checkbox" checked="checked" disabled="disabled" onclick="checkAll(checked)"></input> <label
						...
						<div id="product_11345721" class="item item_selected ">
							<div class="item_form clearfix">
								<div class="cell p-checkbox">
									<input class="checkbox" type="checkbox" disabled="disabled" name="skuIds" checked="checked"
										value="${item.skuId }">
								</div>
